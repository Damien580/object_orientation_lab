...
let name = model
let made = year
console.log(tint, type, name, made)
...
let totalPopulation = (obj) => {
  ...
  let saltLake = utah
  let tahoe = california
  let possumKingdom = texas
  let havasu = arizona
  let lakePop = saltLake + tahoe + possumKingdom + havasu
  return lakePop
}
...
let hobbes = new Cat('Hobbes', 9, 'Orange/White/Black')
console.log(hobbes.name)
...
let damien = new Wizard('Damien', 42, 'CreepingDeath')
console.log(damien)
...
//Code Here
let phone1 = new Phone('samsung', 'galaxy', 256, 'black', 899);
let phone2 = new Phone('nokia', 'lite', 128, 'red', 849);
let phone3 = new Phone('lg', 'nord', 256, 'silver', 799);
let phone4 = new Phone('motorolla', 'razr', 128, 'grey', 749)
let phone5 = new Phone('htc', 'throwaway', 64, 'clear', 699)
/* 
